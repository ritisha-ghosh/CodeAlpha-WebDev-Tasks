...
function toggleMode() {
    ...
    if (body.classList.contains('light-mode')) {
        ...
        inputSection.classList.remove('light-mode');
        expensesList.classList.remove('light-mode');
    } else {
        body.classList.remove('dark-mode');
        body.classList.add('light-mode');
        toggleButtonIcon.classList.remove('fa-sun');
        toggleButtonIcon.classList.add('fa-moon');
        inputSection.classList.add('light-mode');
        expensesList.classList.add('light-mode');
    }
}
